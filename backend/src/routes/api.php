...
Route::middleware('auth:sanctum')->group(function (): void {
	...
	Route::patch('institution-requests/{institutionRequest}/cancel', [InstitutionRequestController::class, 'cancel'])->middleware('role:citizen');
	...
	Route::get('institutions/{institution}/staff/invitations', [InstitutionStaffController::class, 'invitations'])->middleware('role:admin,manager');
	...
	Route::get('institution-invitations/me', [InstitutionStaffController::class, 'myInvitations'])->middleware('auth:sanctum');
	Route::patch('institution-invitations/{institutionInvitation}/accept', [InstitutionStaffController::class, 'acceptInvitation'])->middleware('auth:sanctum');
	Route::patch('institution-invitations/{institutionInvitation}/reject', [InstitutionStaffController::class, 'rejectInvitation'])->middleware('auth:sanctum');
	...
	Route::post('queues', [QueueController::class, 'store'])->middleware('role:institution');
	Route::put('queues/{queue}', [QueueController::class, 'update'])->middleware('role:institution');
	Route::delete('queues/{queue}', [QueueController::class, 'destroy'])->middleware('role:institution');
	...
	Route::put('appointments/{appointment}', [AppointmentController::class, 'update'])->middleware('role:citizen,institution');
	...
	Route::get('appointments/{appointment}/queue-position', [AppointmentController::class, 'queuePosition'])->middleware('role:citizen,institution');
