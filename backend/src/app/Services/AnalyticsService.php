...
{
    public function getDashboardMetricsByInstitution(int $institutionId): array
    {
        $appointments = Appointment::query()
            ->whereHas('service', fn ($query) => $query->where('institution_id', $institutionId));
        ...
        $averageWaitTime = (float) (Appointment::query()
            ...
            ->where('services.institution_id', $institutionId)
